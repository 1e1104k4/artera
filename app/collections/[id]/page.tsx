...
export default async function CollectionDetailPage({ params }: { params: Promise<{ id: string }> }) {
	...
	return (
		<CollectionsChatShell
			...
			session={session}
			hideSidebar
			greetingProps={{ title: 'Finding Colelctions', subtitle: 'Looking for shared traits' }}
		>
